...
!(function (a) {
    ...
    (l.VERSION = "3.6.0"),
        ...
        (l.prototype.toggle = function () {
            let bookingId = this.$element.data("id");
            let bookingStatus = "";
            let self = this;
            ...
            Lobibox.confirm({
                msg: `Are you sure you want to ${bookingStatus} this booking?`,
                callback: function ($this, type, ev) {
                    if(type == 'yes') {
                        const formData = new FormData();
                        formData.append('booking_id', bookingId);
                        formData.append('booking_status', bookingStatus.toUpperCase());
                        // $.ajax({
                        //     url: url,
                        //     type: "POST",
                        //     data: formData,
                        ...
                        //             });
                        //             self.$element.prop("checked") ? self.off() : self.on();
                        //         }
                        //     },
