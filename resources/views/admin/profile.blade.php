            ...
            <div class="card">
                <div class="card-body">
                    <div class="container-xl px-3">
                        <hr class="mt-0 mb-4">
                        <form class="needs-validation" id="form-action" action="{{ route('admin.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <input type="hidden" name="id" id="id" value="{{ $adminDetails->id }}">
                                <div class="col-xl-4">
                                    <!-- Profile picture card-->
                                    <div class="card mb-4 mb-xl-0">
                                        <div class="card-header">Profile Picture</div>
                                        <div class="card-body text-center">
                                            @if(empty($adminDetails->picture))
                                                <img
                                            ...
                                            <img
                                                class="img-account-profile rounded-circle mb-2 w-75" 
                                                src="{{ asset('/fileupload/admin/profile').'/'. $adminDetails->picture }}" 
                                                alt=""
                                                id="picture"
                                                name="picture"
                                                >
                                        ...
                                        <div class="card-body">
                                                <div class="row gx-3 mb-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control disabled" id="fname" name="fname" type="text" placeholder="Enter your first name" value="{{ $adminDetails->fname }}">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="inputLastName">Last name</label>
                                                        <input class="form-control disabled" id="lname" name="lname" type="text" placeholder="Enter your last name" value="{{ $adminDetails->lname }}">
                                                    </div>
                                                </div>
                                                <div class="row gx-3 mb-3">
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="inputOrgName">Phone Number</label>
                                                        <input class="form-control disabled" id="mobile" name="mobile" type="text" placeholder="Enter your phone number"value="{{ $adminDetails->mobile }}">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="inputLocation">Address</label>
                                                        <input class="form-control disabled" id="address" name="address" type="text" placeholder="Enter your address" value="{{ $adminDetails->address }}">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputEmailAddress">Email address</label>
                                                    <input class="form-control disabled" id="email" name="email" type="email" placeholder="Enter your email address" value="{{ $adminDetails->email }}">
                                                </div>
                                                <div class="row gx-3 mb-3">
