                            ...
                            <tbody>
                                @foreach($bookings as $booking)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-danger p-2 booking_status" onclick="updateBookingStatus('{{ $booking->id }}')">
                                                {{ $booking->status }}     
                                            </span>
                                        </td>
                                    </tr>
                ...
                <div class="radio-tile-group">
                    <div class="input-container">
                        ...
                        <div class="radio-tile">
                            ...
                            <label for="walk" class="radio-tile-label">Pending</label>
                        </div>
                    </div>
                    ...
                    <div class="input-container">
                        ...
                        <div class="radio-tile">
                            ...
                            <label for="bike" class="radio-tile-label">Approved</label>
                        </div>
                    </div>
                    ...
                    <div class="input-container">
                        ...
                        <div class="radio-tile">
                            ...
                            <label for="drive" class="radio-tile-label">Rejected</label>
                        </div>
                    </div>
                </div>
